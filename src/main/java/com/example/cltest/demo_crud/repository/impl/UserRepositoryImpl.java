package com.example.cltest.demo_crud.repository.impl;




import com.example.cltest.demo_crud.model.User;
import com.example.cltest.demo_crud.repository.UserRepository;
...
@Repository   // @Repository 注解⽤于标注数据访问组件，同时在类中注⼊ JdbcTemplate，其是 Spring 操作JDBC 提供的⼯具类
